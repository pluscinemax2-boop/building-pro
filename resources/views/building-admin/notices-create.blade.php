...
<div class="min-h-screen flex flex-col items-center justify-center bg-background-light dark:bg-background-dark">
    <div class="max-w-xl w-full bg-white dark:bg-surface-dark rounded-xl shadow-md p-8 border border-border dark:border-gray-800">
        ...
        <form method="POST" action="{{ route('building-admin.notices.store') }}">
            @csrf
            ...
            <div class="mb-4 flex gap-4">
                <div class="flex-1">
                    ...
                    <input type="date" name="visible_from" class="w-full rounded border border-border dark:border-gray-700 px-2 py-1 text-sm bg-white dark:bg-surface-dark text-text-main dark:text-white">
                </div>
                <div class="flex-1">
                    <label class="block text-xs font-medium mb-1 text-text-main dark:text-white">Visible To</label>
                    <input type="date" name="visible_to" class="w-full rounded border border-border dark:border-gray-700 px-2 py-1 text-sm bg-white dark:bg-surface-dark text-text-main dark:text-white">
                </div>
            </div>
